...
type AgentsFilter = {
  bucket: "all" | "baselines" | "external" | "recent" | "mine";
  search: string;
};
...
function readFilter(): AgentsFilter {
  try {
    ...
    return {
      bucket: (["all", "baselines", "external", "recent", "mine"] as const).includes(p.bucket) ? p.bucket : "all",
      ...
      <section>
        ...
        <div class="replays-toolbar">
          <div class="source-pills">
            ...
            <button class="source-pill" data-bucket="recent">Recent</button>
